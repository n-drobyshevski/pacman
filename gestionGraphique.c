...
void printText(int x, int y, const char *text, TTF_Font *font, SDL_Color color,
...
void textPrint(int x, int y, char *text, int wsize, int hsize, TTF_Font *font,
...
void updateRenderer(SDL_Renderer *ren) { SDL_RenderPresent(ren); }
